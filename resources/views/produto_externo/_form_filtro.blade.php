...
<div class="form-group @if ($errors->has('codigo_produto_externo')) has-error @endif">
    ...
    <input id="codigo_produto_externo" type="text" class="form-control @error('codigo_produto_externo') is-invalid @enderror" name="codigo_produto_externo" value="{{(old('codigo_produto_externo'))}}" autocomplete="codigo_produto_externo" autofocus>
...
<div class="form-group @if ($errors->has('nome_produto_externo')) has-error @endif">
    ...
    <input id="nome_produto_externo" type="text" class="form-control @error('nome_produto_externo') is-invalid @enderror" name="nome_produto_externo" value="{{(old('nome_produto_externo'))}}" autocomplete="nome_produto_externo" autofocus>

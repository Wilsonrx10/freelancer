...
<div class="form-group @if ($errors->has('id')) has-error @endif">
    ...
    <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id_produto" value="{{(isset($filtro->id_produto) ? $filtro->id_produto : old('id_produto'))}}" autocomplete="id" autofocus>
    @if ($errors->has('id'))
        <span class="invalid-feedback" role="alert">

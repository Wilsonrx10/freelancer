...
<div class="form-group @if ($errors->has('nome_produto')) has-error @endif">
    ...
    <input id="nome_produto" type="text" class="form-control @error('nome_produto') is-invalid @enderror" name="nome_produto" value="{{(old('nome_produto'))}}" autocomplete="nome_produto" autofocus>

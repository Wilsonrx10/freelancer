...
<div class="form-group @if ($errors->has('code_telegram_canal')) has-error @endif">
    ...
    <input id="code_telegram_canal" type="text" class="form-control @error('code_telegram_canal') is-invalid @enderror" name="code_telegram_canal" value="{{(isset($filtro->code_telegram_canal) ? $filtro->code_telegram_canal : old('code_telegram_canal'))}}" autocomplete="code_telegram_canal" autofocus>
...
<div class="form-group @if ($errors->has('nome_telegram_canal')) has-error @endif">
    ...
    <input id="nome_telegram_canal" type="text" class="form-control @error('nome_telegram_canal') is-invalid @enderror" name="nome_telegram_canal" value="{{(isset($filtro->nome_telegram_canal) ? $filtro->nome_telegram_canal : old('nome_telegram_canal'))}}" autocomplete="nome_telegram_canal" autofocus>
...
<div class="form-group @if ($errors->has('convite')) has-error @endif">
    ...
    <input id="convite" type="text" class="form-control @error('convite') is-invalid @enderror" name="convite" value="{{(isset($filtro->convite) ? $filtro->convite : old('convite'))}}" autocomplete="convite" autofocus>
...
<div class="form-group @if ($errors->has('id')) has-error @endif">
    ...
    <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id_produto" value="{{(isset($filtro->id_produto) ? $filtro->id_produto : old('id_produto'))}}" autocomplete="id_produto" autofocus>
    @if ($errors->has('id'))
        <span class="invalid-feedback" role="alert">
...
<div class="form-group @if ($errors->has('canal_admin')) has-error @endif">
    ...
    <select class="form-control" name="canal_admin" id="canal_admin">
        <option {{ isset($filtro->status) && $filtro->status == 1 ? "selected" : "" }} value="1">Sim</option>
        <option {{ isset($filtro->status) && $filtro->status == 0 ? "selected" : "" }} value="0">Não</option>
    </select>
